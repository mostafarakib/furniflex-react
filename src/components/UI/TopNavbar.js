...
export default function TopNavbar() {
  ...
  return (
    <nav className={`navbar navbar-expand-lg px-3 ${classes.customNavbar}`}>
      <div className="container-fluid">
        <a className={`navbar-brand ${classes.customNavbarBrand}`} href="#">
          <img className={classes.logo} src={logo} alt="logo of the company" />{" "}
          Furni<span>Flex</span>
        </a>
        <button className={`${classes["cart-button"]} ms-auto d-lg-none`}>
          <svg
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M 15 6.022 L 15 6 C 15 4.343 13.657 3 12 3 C 10.343 3 9 4.343 9 6 L 9.037 6.022"
                stroke="#000000"
                strokeWidth="2"
                strokeLinecap="round"
              />
        ...
        <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <a className={`nav-link ${classes.customNavLink}`} href="#">
                Products
              </a>
            </li>
            <li className="nav-item">
          ...
          <div>
            <button
              className={`${classes["cart-button"]} d-none d-lg-inline-block`}
            >
              <svg
                viewBox="-2.4 -2.4 28.8 28.8"
                fill="none"
